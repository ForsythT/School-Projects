...
public:
	...
	int util(OthelloBoard *board);
	std::vector<OthelloBoard*> succ(char symb, OthelloBoard *board);
	int minValue(int &row, int &col, OthelloBoard *board);
	int maxValue(int &row, int &col, OthelloBoard *board);
