...
entry:
  ...
  %multmp12 = fmul float %pi11, 2.000000e+00
  ...
  %multmp18 = fmul float 0x3FF5555560000000, %pi17
  ...
  %sphere_surf_area28 = load float, float* %sphere_surf_area
  ret float %sphere_surf_area28
}
