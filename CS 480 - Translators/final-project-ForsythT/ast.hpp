 ...
 *
 * Each non-abstract class below also has a method called generateLLVMSpec().
...
public:
  virtual ~ASTNode() {}
  virtual llvm::Value* generateLLVMSpec() const = 0;
};
...
public:
  ...
  virtual llvm::Value* generateLLVMSpec() const;
};
